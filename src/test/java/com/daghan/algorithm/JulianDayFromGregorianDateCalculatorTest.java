 ...
 */
public class JulianDayFromGregorianDateCalculatorTest {

	JulianDayCalculator unitUnderTest = JulianDayCalculatorFactory
	...
	public void testFirstDate() {
		...
		assertEquals(2451544.5, result, 0.0);
	}
	...
	public void testSecondDate() {
		...
		double result = unitUnderTest.getJulianDay(testDate);
		assertEquals(2451545.5, result, 0.0);
	}
